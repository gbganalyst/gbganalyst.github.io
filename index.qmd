...
I am honored to be a Mastercard Scholar, Federal Government of Nigeria (FSB) Scholar, UNLEASH Talent, Heidelberg Laureate Forum (HLF) Fellow, and Capacity Accelerator Network (CAN) Fellow of the Global Partnership for Sustainable Development Data.
  ...
  <a href="https://gbganalyst.github.io/forstringr/" target="_blank"><span style='text-decoration: underline;text-decoration-color: #E6AA04;'>forstringr </span></a> CRAN R programming packages and contributed to the 'Big Book of R' and the 'ralger' package. I co-edited the "Beginners’ Artificial Intelligence & Python Programming Book" and helped create the Nigeria COVID-19 data repository for researchers.    
      </p>
           
           <p>
    As an active member of the Africa R programming community and a certified RStudio Tidyverse instructor, I have published ten research papers and provided consultancy to clients worldwide. I excel in data wrangling, analysis, tool-building, and process automation, and am dedicated to leveraging data to solve real-world problems and drive sustainable development.
           </p>
...
-   **May 25, 2024:** The `bulkreadr` package is now available on CRAN. `bulkreadr` is an R package that simplifies and streamlines the process of reading and processing large volumes of data. It allows users to efficiently read multiple sheets from Microsoft Excel/Google Sheets workbooks and multiple CSV files from a directory. [Learn more](https://gbganalyst.github.io/bulkreadr).

![bulkreadr Concept Map](images/concept-map.png){fig-alt="bulkreadr concept map"}
...
-   **December, 2019:** I joined Data Science Nigeria as a Data Scientist on December 4, 2019.
